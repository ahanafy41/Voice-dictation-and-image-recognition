...
.field transient f:Lbsh/Parser;

.field g:Lbsh/NameSpace;
...
.field k:Lbsh/ConsoleInterface;

.field l:Lbsh/Interpreter;
...
.method public constructor <init>(Ljava/io/Reader;Ljava/io/PrintStream;Ljava/io/PrintStream;ZLbsh/NameSpace;Lbsh/Interpreter;Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lbsh/Interpreter;->e:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lbsh/Interpreter;->n:Z

    new-instance v0, Lbsh/Parser;

    invoke-direct {v0, p1}, Lbsh/Parser;-><init>(Ljava/io/Reader;)V

    iput-object v0, p0, Lbsh/Interpreter;->f:Lbsh/Parser;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-object p1, p0, Lbsh/Interpreter;->h:Ljava/io/Reader;

    iput-object p2, p0, Lbsh/Interpreter;->i:Ljava/io/PrintStream;

    iput-object p3, p0, Lbsh/Interpreter;->j:Ljava/io/PrintStream;

    iput-boolean p4, p0, Lbsh/Interpreter;->p:Z

    sput-object p3, Lbsh/Interpreter;->a:Ljava/io/PrintStream;

    iput-object p6, p0, Lbsh/Interpreter;->l:Lbsh/Interpreter;
    ...
    :cond_0
    iput-object p7, p0, Lbsh/Interpreter;->m:Ljava/lang/String;
    ...
    iput-object p2, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;

    goto :goto_0

    :cond_1
    iput-object p5, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;

    :goto_0
    const-string p1, "bsh"

    invoke-virtual {p0, p1}, Lbsh/Interpreter;->b(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lbsh/Interpreter;->f()V
...
.method private c()Z
    ...
    iget-object v0, p0, Lbsh/Interpreter;->f:Lbsh/Parser;
...
.method private e()Lbsh/JJTParserState;
    .locals 1
...
.method private f()V
    ...
    invoke-virtual {p0, v3, v2}, Lbsh/Interpreter;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    sput-object v2, Lbsh/Interpreter;->c:Lbsh/This;
    ...
    const-string v2, "bsh.help"

    invoke-virtual {p0, v2, v1}, Lbsh/Interpreter;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-boolean v1, p0, Lbsh/Interpreter;->p:Z
    ...
    iget-boolean v1, p0, Lbsh/Interpreter;->o:Z
...
.method public static invokeMain(Ljava/lang/Class;[Ljava/lang/String;)V
    ...
    sget-object v2, Lbsh/Interpreter;->d:Ljava/lang/Class;

    if-nez v2, :cond_0

    const-string v2, "[Ljava.lang.String;"

    invoke-static {v2}, Lbsh/Interpreter;->a(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lbsh/Interpreter;->d:Ljava/lang/Class;
    ...
    invoke-static {v2, p0, v4, v1, v0}, Lbsh/Reflect;->a(Lbsh/BshClassManager;Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;Z)Ljava/lang/reflect/Method;
...
.method public static main([Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;
...
.method a()V
    ...
    iget-object v1, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;
...
.method public final error(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lbsh/Interpreter;->k:Lbsh/ConsoleInterface;
    ...
    iget-object p1, p0, Lbsh/Interpreter;->j:Ljava/io/PrintStream;
...
.method public eval(Ljava/io/Reader;Lbsh/NameSpace;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lbsh/Interpreter;->i:Ljava/io/PrintStream;

    iget-object v5, p0, Lbsh/Interpreter;->j:Ljava/io/PrintStream;
    ...
    :try_start_0
    invoke-direct {v1}, Lbsh/Interpreter;->c()Z

    move-result v2

    invoke-direct {v1}, Lbsh/Interpreter;->e()Lbsh/JJTParserState;

    move-result-object v6

    invoke-virtual {v6}, Lbsh/JJTParserState;->a()I
    ...
    invoke-virtual {v6}, Lbsh/JJTParserState;->d()Lbsh/Node;

    move-result-object v6

    check-cast v6, Lbsh/SimpleNode;
    :try_end_0
    .catch Lbsh/ParseException; {:try_start_0 .. :try_end_0} :catch_a
    .catch Lbsh/InterpreterError; {:try_start_0 .. :try_end_0} :catch_9
    .catch Lbsh/TargetError; {:try_start_0 .. :try_end_0} :catch_8
    .catch Lbsh/EvalError; {:try_start_0 .. :try_end_0} :catch_7
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_6
    .catch Lbsh/TokenMgrError; {:try_start_0 .. :try_end_0} :catch_5
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-virtual {v6, p3}, Lbsh/SimpleNode;->setSourceFile(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lbsh/SimpleNode;->getText()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v6, p1, v1}, Lbsh/SimpleNode;->eval(Lbsh/CallStack;Lbsh/Interpreter;)Ljava/lang/Object;
    ...
    :try_end_1
    .catch Lbsh/ParseException; {:try_start_1 .. :try_end_1} :catch_a
    ...
    invoke-virtual {p3}, Lbsh/JJTParserState;->c()V
    ...
    :cond_5
    :try_start_2
    iget-boolean v7, v1, Lbsh/Interpreter;->q:Z
    ...
    throw v7
    :try_end_2
    .catch Lbsh/ParseException; {:try_start_2 .. :try_end_2} :catch_a
    ...
    invoke-virtual {v6}, Lbsh/JJTParserState;->c()V
    ...
    invoke-direct {v3, p3, v6, p1}, Lbsh/EvalError;-><init>(Ljava/lang/String;Lbsh/SimpleNode;Lbsh/CallStack;)V
    ...
    :cond_9
    invoke-virtual {v7}, Lbsh/EvalError;->a()Lbsh/SimpleNode;

    move-result-object v8

    if-nez v8, :cond_a

    invoke-virtual {v7, v6}, Lbsh/EvalError;->a(Lbsh/SimpleNode;)V
    ...
    invoke-virtual {v7, v6}, Lbsh/EvalError;->reThrow(Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-virtual {v0, v2}, Lbsh/ParseException;->getMessage(Z)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lbsh/JJTParserState;->c()V
...
.method public getIn()Ljava/io/Reader;
    ...
    iget-object v0, p0, Lbsh/Interpreter;->h:Ljava/io/Reader;
...
.method public getOut()Ljava/io/PrintStream;
    ...
    iget-object v0, p0, Lbsh/Interpreter;->i:Ljava/io/PrintStream;
...
.method public getParent()Lbsh/Interpreter;
    ...
    iget-object v0, p0, Lbsh/Interpreter;->l:Lbsh/Interpreter;
...
.method public getSourceFileInfo()Ljava/lang/String;
    ...
    iget-object v0, p0, Lbsh/Interpreter;->m:Ljava/lang/String;
...
.method public getStrictJava()Z
    ...
    iget-boolean v0, p0, Lbsh/Interpreter;->e:Z
...
.method public pathToFile(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, v0}, Lbsh/Interpreter;->b(Ljava/lang/String;)Ljava/lang/Object;
...
.method public final print(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lbsh/Interpreter;->i:Ljava/io/PrintStream;
...
.method public run()V
    ...
    iget-boolean v0, p0, Lbsh/Interpreter;->n:Z
    ...
    iget-boolean v4, p0, Lbsh/Interpreter;->p:Z

    if-eqz v4, :cond_4

    invoke-direct {p0}, Lbsh/Interpreter;->d()Ljava/lang/String;
    ...
    :cond_4
    invoke-direct {p0}, Lbsh/Interpreter;->c()Z

    move-result v2

    invoke-direct {p0}, Lbsh/Interpreter;->e()Lbsh/JJTParserState;

    move-result-object v4

    invoke-virtual {v4}, Lbsh/JJTParserState;->a()I
    ...
    invoke-virtual {v4}, Lbsh/JJTParserState;->d()Lbsh/Node;
    ...
    :try_start_2
    invoke-virtual {v4, v6}, Lbsh/SimpleNode;->dump(Ljava/lang/String;)V

    :cond_5
    invoke-virtual {v4, v0, p0}, Lbsh/SimpleNode;->eval(Lbsh/CallStack;Lbsh/Interpreter;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v5, v4}, Lbsh/Interpreter;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v4}, Lbsh/JJTParserState;->c()V
    ...
    iget-object v3, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;
    ...
    iget-object v4, p0, Lbsh/Interpreter;->f:Lbsh/Parser;

    iget-object v5, p0, Lbsh/Interpreter;->h:Ljava/io/Reader;

    invoke-virtual {v4, v5}, Lbsh/Parser;->b(Ljava/io/Reader;)V
    ...
    invoke-virtual {v4}, Lbsh/EvalError;->toString()Ljava/lang/String;
    ...
    iget-object v6, p0, Lbsh/Interpreter;->j:Ljava/io/PrintStream;
    ...
    invoke-virtual {v4, v6}, Lbsh/ParseException;->getMessage(Z)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lbsh/JJTParserState;->c()V
    ...
    iget-object v2, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;
...
.method public setConsole(Lbsh/ConsoleInterface;)V
    ...
    iput-object p1, p0, Lbsh/Interpreter;->k:Lbsh/ConsoleInterface;
...
.method public setExitOnEOF(Z)V
    ...
    iput-boolean p1, p0, Lbsh/Interpreter;->n:Z
...
.method public setNameSpace(Lbsh/NameSpace;)V
    ...
    iput-object p1, p0, Lbsh/Interpreter;->g:Lbsh/NameSpace;
...
.method public setOut(Ljava/io/PrintStream;)V
    ...
    iput-object p1, p0, Lbsh/Interpreter;->i:Ljava/io/PrintStream;
...
.method public setStrictJava(Z)V
    ...
    iput-boolean p1, p0, Lbsh/Interpreter;->e:Z
