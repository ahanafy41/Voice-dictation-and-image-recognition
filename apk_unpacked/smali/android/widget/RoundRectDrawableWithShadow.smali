...
.field static b:Landroid/widget/RoundRectDrawableWithShadow$RoundRectHelper;
...
.method constructor <init>(Landroid/content/res/Resources;IFFF)V
    ...
    iput p1, p0, Landroid/widget/RoundRectDrawableWithShadow;->c:I
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Landroid/widget/RoundRectDrawableWithShadow;->l:F

    sub-float/2addr v1, v2

    iget v2, p0, Landroid/widget/RoundRectDrawableWithShadow;->c:I
    ...
    :goto_0
    iget-object v6, p0, Landroid/widget/RoundRectDrawableWithShadow;->g:Landroid/graphics/RectF;
    ...
    iget-object v3, p0, Landroid/widget/RoundRectDrawableWithShadow;->i:Landroid/graphics/Path;

    iget-object v4, p0, Landroid/widget/RoundRectDrawableWithShadow;->e:Landroid/graphics/Paint;
    ...
    iget v3, p0, Landroid/widget/RoundRectDrawableWithShadow;->h:F

    neg-float v7, v3

    iget-object v8, p0, Landroid/widget/RoundRectDrawableWithShadow;->f:Landroid/graphics/Paint;
    ...
    iget v3, p0, Landroid/widget/RoundRectDrawableWithShadow;->l:F
    ...
    iget-object v0, p0, Landroid/widget/RoundRectDrawableWithShadow;->i:Landroid/graphics/Path;
    ...
    iget-object v0, p0, Landroid/widget/RoundRectDrawableWithShadow;->g:Landroid/graphics/RectF;
...
.method private f()V
    ...
    iget v2, v0, Landroid/widget/RoundRectDrawableWithShadow;->l:F

    add-float v3, v1, v2

    div-float v3, v1, v3

    iget-object v4, v0, Landroid/widget/RoundRectDrawableWithShadow;->e:Landroid/graphics/Paint;
    ...
    iget v2, v0, Landroid/widget/RoundRectDrawableWithShadow;->o:I
    ...
    iget v2, v0, Landroid/widget/RoundRectDrawableWithShadow;->p:I
    ...
    iget-object v2, v0, Landroid/widget/RoundRectDrawableWithShadow;->f:Landroid/graphics/Paint;
...
.method a(FF)V
    ...
    :cond_1
    iget v1, p0, Landroid/widget/RoundRectDrawableWithShadow;->m:F
    ...
    iget v1, p0, Landroid/widget/RoundRectDrawableWithShadow;->c:I
...
.method d()F
    ...
    iget v3, p0, Landroid/widget/RoundRectDrawableWithShadow;->c:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/widget/RoundRectDrawableWithShadow;->b:Landroid/widget/RoundRectDrawableWithShadow$RoundRectHelper;
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v1, v2, v3}, Landroid/widget/RoundRectDrawableWithShadow;->a(FFZ)F
