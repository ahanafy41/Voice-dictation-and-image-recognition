...
.method public constructor <init>(Landroid/widget/PullingLayout;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
...
.method private a(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v2, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v4, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v1, p0, Landroid/widget/PullingLayout$FootView;->d:Landroid/widget/ImageView;

    new-instance v6, Landroid/widget/PullingLayout$PullUpDrawable;

    iget-object v7, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v6, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v8, p0, Landroid/widget/PullingLayout$FootView;->d:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$FootView;->a:Landroid/widget/ImageView;

    iget-object v1, p0, Landroid/widget/PullingLayout$FootView;->a:Landroid/widget/ImageView;
    ...
    iget-object v10, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v9, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;
    ...
    iget-object v9, p0, Landroid/widget/PullingLayout$FootView;->a:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$FootView;->b:Landroid/widget/TextView;

    iget-object v1, p0, Landroid/widget/PullingLayout$FootView;->b:Landroid/widget/TextView;

    iget-object v9, p0, Landroid/widget/PullingLayout$FootView;->e:Landroid/widget/PullingLayout;

    invoke-static {v9}, Landroid/widget/PullingLayout;->e(Landroid/widget/PullingLayout;)Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/widget/PullingLayout$FootView;->b:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroid/widget/PullingLayout$FootView;->c:Landroid/widget/ImageView;

    iget-object p1, p0, Landroid/widget/PullingLayout$FootView;->c:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$FootView;->c:Landroid/widget/ImageView;
...
.method public getLoadingView()Landroid/widget/ImageView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$FootView;->a:Landroid/widget/ImageView;
...
.method public getStateText()Landroid/widget/TextView;
    ...
    iget-object v0, p0, Landroid/widget/PullingLayout$FootView;->b:Landroid/widget/TextView;
