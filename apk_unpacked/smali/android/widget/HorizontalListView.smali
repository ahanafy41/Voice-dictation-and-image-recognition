...
.field private final c:Landroid/widget/HorizontalListView$GestureListener;

.field private d:Landroid/view/GestureDetector;

.field private e:I

.field protected f:Landroid/widget/ListAdapter;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/widget/HorizontalListView;->b:Landroid/widget/Scroller;
    ...
    iput-object p2, p0, Landroid/widget/HorizontalListView;->c:Landroid/widget/HorizontalListView$GestureListener;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, Landroid/widget/HorizontalListView;->g:Ljava/util/List;

    const/4 p2, 0x0

    iput-boolean p2, p0, Landroid/widget/HorizontalListView;->h:Z

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Landroid/widget/HorizontalListView;->i:Landroid/graphics/Rect;

    iput-object v0, p0, Landroid/widget/HorizontalListView;->j:Landroid/view/View;

    iput p2, p0, Landroid/widget/HorizontalListView;->k:I

    iput-object v0, p0, Landroid/widget/HorizontalListView;->l:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/widget/HorizontalListView;->a:Landroid/util/DisplayMetrics;
    ...
    iget-object v1, p0, Landroid/widget/HorizontalListView;->c:Landroid/widget/HorizontalListView$GestureListener;

    invoke-direct {v0, p1, v1}, Landroid/view/GestureDetector;-><init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;)V

    iput-object v0, p0, Landroid/widget/HorizontalListView;->d:Landroid/view/GestureDetector;

    invoke-direct {p0}, Landroid/widget/HorizontalListView;->d()V

    invoke-virtual {p0, p2}, Landroid/widget/AdapterView;->setWillNotDraw(Z)V

    iget-object p1, p0, Landroid/widget/HorizontalListView;->b:Landroid/widget/Scroller;
...
.method private a()F
    ...
    iget-object v0, p0, Landroid/widget/HorizontalListView;->b:Landroid/widget/Scroller;
...
.method private a(F)I
    ...
    iget-object v0, p0, Landroid/widget/HorizontalListView;->a:Landroid/util/DisplayMetrics;
...
.method static synthetic a(Landroid/widget/HorizontalListView;)Landroid/view/GestureDetector;
    ...
    iget-object p0, p0, Landroid/widget/HorizontalListView;->d:Landroid/view/GestureDetector;
...
.method private a(I)V
    ...
    :goto_0
    invoke-direct {p0, v0, p1}, Landroid/widget/HorizontalListView;->b(II)V
    ...
    :cond_1
    invoke-direct {p0, v1, p1}, Landroid/widget/HorizontalListView;->a(II)V
...
.method private a(II)V
    ...
    iget v1, p0, Landroid/widget/HorizontalListView;->k:I
    ...
    iget-object v0, p0, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;

    iget v1, p0, Landroid/widget/HorizontalListView;->q:I

    invoke-direct {p0, v1}, Landroid/widget/HorizontalListView;->c(I)Landroid/view/View;
    ...
    iget v1, p0, Landroid/widget/HorizontalListView;->e:I
    ...
    :cond_1
    iget v2, p0, Landroid/widget/HorizontalListView;->k:I
    ...
    iput v1, p0, Landroid/widget/HorizontalListView;->e:I
...
.method private a(ILandroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroid/widget/HorizontalListView;->e(I)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/widget/HorizontalListView;->g:Ljava/util/List;
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/widget/HorizontalListView;->i:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroid/widget/HorizontalListView;->i:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v3}, Landroid/widget/HorizontalListView;->f(I)Z
    ...
    iget v5, p0, Landroid/widget/HorizontalListView;->k:I
...
.method private a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/widget/HorizontalListView;->l:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p2}, Landroid/graphics/drawable/Drawable;->setBounds(Landroid/graphics/Rect;)V

    iget-object p2, p0, Landroid/widget/HorizontalListView;->l:Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1}, Landroid/widget/HorizontalListView;->a(Landroid/view/View;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {p0, p1}, Landroid/widget/HorizontalListView;->b(Landroid/view/View;)V
...
.method static synthetic a(Landroid/widget/HorizontalListView;Z)Z
    ...
    iput-boolean p1, p0, Landroid/widget/HorizontalListView;->h:Z
...
.method private b(II)V
    ...
    iget-object v1, p0, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;
...
.method private b(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, Landroid/widget/HorizontalListView;->e()Z
...
.method static synthetic b(Landroid/widget/HorizontalListView;)Z
    .locals 0
...
.method private c(II)I
    ...
    iget-object v3, p0, Landroid/widget/HorizontalListView;->i:Landroid/graphics/Rect;
...
.method static synthetic c(Landroid/widget/HorizontalListView;)I
    .locals 0
...
.method private c()Z
    ...
    invoke-direct {p0, v0}, Landroid/widget/HorizontalListView;->f(I)Z
...
.method static synthetic d(Landroid/widget/HorizontalListView;)Landroid/view/View$OnClickListener;
    .locals 0
...
.method private d()V
    ...
    iput v0, p0, Landroid/widget/HorizontalListView;->e:I

    iput v0, p0, Landroid/widget/HorizontalListView;->m:I

    iput v0, p0, Landroid/widget/HorizontalListView;->n:I
...
.method private d(I)V
    ...
    iget-object v1, p0, Landroid/widget/HorizontalListView;->g:Ljava/util/List;
...
.method static synthetic e(Landroid/widget/HorizontalListView;)V
    .locals 0

    invoke-direct {p0}, Landroid/widget/HorizontalListView;->h()V
...
.method static synthetic f(Landroid/widget/HorizontalListView;)V
    .locals 0
...
.method private g(I)V
    ...
    iget v3, p0, Landroid/widget/HorizontalListView;->e:I

    add-int/2addr v3, p1

    iput v3, p0, Landroid/widget/HorizontalListView;->e:I

    iget p1, p0, Landroid/widget/HorizontalListView;->e:I
    ...
    iget v4, p0, Landroid/widget/HorizontalListView;->k:I
...
.method private h()V
    ...
    iget-object v0, p0, Landroid/widget/HorizontalListView;->j:Landroid/view/View;
...
.method private h(I)V
    ...
    invoke-direct {p0, v2}, Landroid/widget/HorizontalListView;->f(I)Z
...
.method private i(I)V
    ...
    :cond_0
    iget v0, p0, Landroid/widget/HorizontalListView;->m:I

    add-int/2addr v0, p1

    iget-object v1, p0, Landroid/widget/HorizontalListView;->b:Landroid/widget/Scroller;
...
.method protected a(Landroid/view/MotionEvent;)Z
    ...
    iput-object p1, p0, Landroid/widget/HorizontalListView;->j:Landroid/view/View;

    iget-object p1, p0, Landroid/widget/HorizontalListView;->j:Landroid/view/View;
...
.method protected a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    iget v1, p0, Landroid/widget/HorizontalListView;->n:I
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroid/widget/HorizontalListView;->d:Landroid/view/GestureDetector;
    ...
    :cond_0
    iput-object v2, p0, Landroid/widget/HorizontalListView;->E:Landroid/graphics/Rect;
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-direct {p0, v0}, Landroid/widget/HorizontalListView;->b(I)Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v0, p0, Landroid/widget/HorizontalListView;->h:Z
    ...
    iput-boolean v1, p0, Landroid/widget/HorizontalListView;->h:Z
    ...
    :cond_3
    iget v0, p0, Landroid/widget/HorizontalListView;->n:I

    const/4 v2, 0x1

    if-gez v0, :cond_5

    iput v1, p0, Landroid/widget/HorizontalListView;->n:I
    ...
    :goto_0
    invoke-direct {p0}, Landroid/widget/HorizontalListView;->a()F
    ...
    invoke-direct {p0, v0}, Landroid/widget/HorizontalListView;->h(I)V

    invoke-direct {p0, v0}, Landroid/widget/HorizontalListView;->a(I)V

    invoke-direct {p0, v0}, Landroid/widget/HorizontalListView;->g(I)V

    iget v0, p0, Landroid/widget/HorizontalListView;->n:I

    iput v0, p0, Landroid/widget/HorizontalListView;->m:I

    invoke-direct {p0}, Landroid/widget/HorizontalListView;->c()Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/widget/AdapterView;->setMeasuredDimension(II)V
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;

    iget-object p1, p0, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;
    ...
    invoke-direct {p0, p1}, Landroid/widget/HorizontalListView;->d(I)V
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroid/widget/HorizontalListView;->l:Landroid/graphics/drawable/Drawable;
...
.method public setDividerWidth(I)V
    ...
    iput p1, p0, Landroid/widget/HorizontalListView;->k:I
...
.method public setSelection(I)V
    ...
    iget-object v3, p0, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;
    ...
    invoke-direct {p0, v2}, Landroid/widget/HorizontalListView;->b(Landroid/view/View;)V
    ...
    :cond_2
    iget v3, p0, Landroid/widget/HorizontalListView;->k:I
    ...
    :cond_3
    invoke-virtual {p0, v0}, Landroid/widget/HorizontalListView;->scrollTo(I)V
