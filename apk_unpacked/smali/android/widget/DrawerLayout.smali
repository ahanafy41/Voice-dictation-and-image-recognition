...
.field static final d:Landroid/widget/DrawerLayout$DrawerLayoutCompatImpl;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/widget/DrawerLayout;->a:[I
    ...
    :goto_0
    sput-boolean v1, Landroid/widget/DrawerLayout;->b:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/widget/DrawerLayout;->c:Z
    ...
    :goto_2
    sput-object v0, Landroid/widget/DrawerLayout;->d:Landroid/widget/DrawerLayout$DrawerLayoutCompatImpl;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setAccessibilityDelegate(Landroid/view/View$AccessibilityDelegate;)V
    ...
    sget-object p2, Landroid/widget/DrawerLayout;->d:Landroid/widget/DrawerLayout$DrawerLayoutCompatImpl;
...
.method static synthetic a()[I
    ...
    sget-object v0, Landroid/widget/DrawerLayout;->a:[I
...
.method private f()Z
    ...
    invoke-direct {p0}, Landroid/widget/DrawerLayout;->d()Landroid/view/View;
...
.method private i()V
    ...
    sget-boolean v0, Landroid/widget/DrawerLayout;->c:Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/widget/DrawerLayout;->g()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroid/widget/DrawerLayout;->z:Landroid/graphics/drawable/Drawable;

    invoke-direct {p0}, Landroid/widget/DrawerLayout;->h()Landroid/graphics/drawable/Drawable;
...
.method a(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Landroid/widget/DrawerLayout;->c(Landroid/view/View;)I
...
.method a(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/widget/DrawerLayout;->c(Landroid/view/View;)I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0}, Landroid/widget/DrawerLayout;->c()Landroid/view/View;
    ...
    :cond_2
    sget-boolean p2, Landroid/widget/DrawerLayout;->b:Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {p0, v2}, Landroid/widget/DrawerLayout;->e(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, v12}, Landroid/widget/DrawerLayout;->f(Landroid/view/View;)Z
    ...
    :cond_0
    invoke-virtual {p0, v12, v7}, Landroid/widget/DrawerLayout;->a(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v2, v7}, Landroid/widget/DrawerLayout;->a(Landroid/view/View;I)Z
    ...
    iget-object v8, v0, Landroid/widget/DrawerLayout;->k:Landroid/widget/ViewDragHelper;

    invoke-virtual {v8}, Landroid/widget/ViewDragHelper;->getEdgeSize()I
    ...
    invoke-virtual {p0, v2, v3}, Landroid/widget/DrawerLayout;->a(Landroid/view/View;I)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/widget/DrawerLayout;->d:Landroid/widget/DrawerLayout$DrawerLayoutCompatImpl;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v4}, Landroid/widget/ViewDragHelper;->checkTouchSlop(I)Z
    ...
    invoke-direct {p0}, Landroid/widget/DrawerLayout;->e()Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Landroid/widget/DrawerLayout;->f()Z
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v7, Landroid/widget/DrawerLayout$LayoutParams;

    invoke-virtual {v0, v6}, Landroid/widget/DrawerLayout;->e(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v6, v10}, Landroid/widget/DrawerLayout;->a(Landroid/view/View;I)Z
    ...
    iget v12, v7, Landroid/widget/DrawerLayout$LayoutParams;->a:F
    ...
    iget v11, v7, Landroid/widget/DrawerLayout$LayoutParams;->a:F
    ...
    :goto_2
    iget v13, v7, Landroid/widget/DrawerLayout$LayoutParams;->gravity:I
    ...
    invoke-virtual {v0, v6, v12}, Landroid/widget/DrawerLayout;->b(Landroid/view/View;F)V

    :cond_8
    iget v1, v7, Landroid/widget/DrawerLayout$LayoutParams;->a:F
...
.method protected onMeasure(II)V
    ...
    sget-object v11, Landroid/widget/DrawerLayout;->d:Landroid/widget/DrawerLayout$DrawerLayoutCompatImpl;
    ...
    sget-boolean v10, Landroid/widget/DrawerLayout;->c:Z
    ...
    :cond_a
    invoke-virtual {p0, v8}, Landroid/widget/DrawerLayout;->c(Landroid/view/View;)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    invoke-direct {p0}, Landroid/widget/DrawerLayout;->i()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, Landroid/widget/DrawerLayout;->a(Z)V
    ...
    invoke-virtual {v3, v4, v5}, Landroid/widget/ViewDragHelper;->findTopChildUnder(II)Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_3

    invoke-virtual {p0, v3}, Landroid/widget/DrawerLayout;->e(Landroid/view/View;)Z

    move-result v3

    if-eqz v3, :cond_3

    iget v3, p0, Landroid/widget/DrawerLayout;->w:F

    sub-float/2addr v0, v3

    iget v3, p0, Landroid/widget/DrawerLayout;->x:F

    sub-float/2addr p1, v3

    iget-object v3, p0, Landroid/widget/DrawerLayout;->k:Landroid/widget/ViewDragHelper;

    invoke-virtual {v3}, Landroid/widget/ViewDragHelper;->getTouchSlop()I
    ...
    iput-boolean v2, p0, Landroid/widget/DrawerLayout;->t:Z
    ...
    iput-boolean v2, p0, Landroid/widget/DrawerLayout;->u:Z
