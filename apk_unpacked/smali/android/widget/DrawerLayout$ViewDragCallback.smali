...
.field private b:Landroid/widget/ViewDragHelper;

.field private final c:Ljava/lang/Runnable;

.field final synthetic d:Landroid/widget/DrawerLayout;
...
.method public constructor <init>(Landroid/widget/DrawerLayout;I)V
    ...
    iput-object p1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
    ...
    iput-object p1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->c:Ljava/lang/Runnable;

    iput p2, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->a:I
...
.method private a()V
    ...
    iget v0, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->a:I
    ...
    :cond_0
    iget-object v0, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
    ...
    iget-object v1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
...
.method private b()V
    ...
    iget-object v0, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->b:Landroid/widget/ViewDragHelper;

    invoke-virtual {v0}, Landroid/widget/ViewDragHelper;->getEdgeSize()I

    move-result v0

    iget v1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->a:I
    ...
    iget-object v5, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
    ...
    :cond_2
    iget-object v3, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;

    const/4 v4, 0x5

    invoke-virtual {v3, v4}, Landroid/widget/DrawerLayout;->a(I)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->b:Landroid/widget/ViewDragHelper;

    invoke-virtual {v4}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v1, v4, v3, v5}, Landroid/widget/ViewDragHelper;->smoothSlideViewTo(Landroid/view/View;II)Z

    iput-boolean v2, v0, Landroid/widget/DrawerLayout$LayoutParams;->b:Z
...
.method public clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    iget-object p3, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
...
.method public onEdgeDragStarted(II)V
    ...
    iget-object p1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
...
.method public onEdgeTouched(II)V
    ...
    iget-object p2, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->c:Ljava/lang/Runnable;
...
.method public onViewDragStateChanged(I)V
    ...
    iget-object v2, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->b:Landroid/widget/ViewDragHelper;
...
.method public onViewPositionChanged(Landroid/view/View;IIII)V
    ...
    iget-object p4, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
...
.method public onViewReleased(Landroid/view/View;FF)V
    ...
    invoke-virtual {p3, p1}, Landroid/widget/DrawerLayout;->d(Landroid/view/View;)F
    ...
    :goto_1
    iget-object p3, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->b:Landroid/widget/ViewDragHelper;
...
.method public removeCallbacks()V
    ...
    iget-object v1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->c:Ljava/lang/Runnable;
...
.method public setDragger(Landroid/widget/ViewDragHelper;)V
    ...
    iput-object p1, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->b:Landroid/widget/ViewDragHelper;
...
.method public tryCaptureView(Landroid/view/View;I)Z
    ...
    iget-object p2, p0, Landroid/widget/DrawerLayout$ViewDragCallback;->d:Landroid/widget/DrawerLayout;
