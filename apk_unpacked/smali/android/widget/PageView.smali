...
.field private ca:Landroid/widget/PageView$OnPageChangeListener;

.field private da:Landroid/widget/PageView$OnPageChangeListener;
...
.field private ea:Landroid/widget/PageView$OnAdapterChangeListener;

.field private final f:Landroid/widget/PageView$ItemInfo;

.field private fa:Landroid/widget/PageView$PageTransformer;

.field private final g:Landroid/graphics/Rect;

.field private ga:Ljava/lang/reflect/Method;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, Landroid/widget/PageView;->ja:I

    new-instance p1, Landroid/widget/PageView$3;

    invoke-direct {p1, p0}, Landroid/widget/PageView$3;-><init>(Landroid/widget/PageView;)V

    iput-object p1, p0, Landroid/widget/PageView;->ka:Ljava/lang/Runnable;

    iput-boolean v0, p0, Landroid/widget/PageView;->la:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean p2, p0, Landroid/widget/PageView;->la:Z
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, p2}, Landroid/widget/PageView;->a(I)Landroid/widget/PageView$ItemInfo;
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/PageView;->a(I)Landroid/widget/PageView$ItemInfo;
    ...
    invoke-direct {p0, p1}, Landroid/widget/PageView;->c(I)V
    ...
    invoke-direct {p0, v0}, Landroid/widget/PageView;->e(I)Z
...
.method private a(Landroid/widget/PageView$ItemInfo;ILandroid/widget/PageView$ItemInfo;)V
    ...
    :goto_7
    iput v4, p0, Landroid/widget/PageView;->t:F
    ...
    iget v4, p1, Landroid/widget/PageView$ItemInfo;->e:F
    ...
    :goto_8
    iput v4, p0, Landroid/widget/PageView;->u:F
    ...
    invoke-virtual {v8, v5}, Landroid/widget/BasePageAdapter;->getPageWidth(I)F
    ...
    :cond_9
    iget v9, v7, Landroid/widget/PageView$ItemInfo;->d:F
...
.method private a(Z)V
    ...
    iget v0, p0, Landroid/widget/PageView;->ja:I
    ...
    invoke-direct {p0, v5}, Landroid/widget/PageView;->e(I)Z
    ...
    iget-object p1, p0, Landroid/widget/PageView;->ka:Ljava/lang/Runnable;
...
.method private b(IFI)V
    ...
    iget-object v0, p0, Landroid/widget/PageView;->ca:Landroid/widget/PageView$OnPageChangeListener;
    ...
    :cond_0
    iget-object v0, p0, Landroid/widget/PageView;->ba:Ljava/util/List;
    ...
    iget-object v2, p0, Landroid/widget/PageView;->ba:Ljava/util/List;
    ...
    :cond_2
    iget-object v0, p0, Landroid/widget/PageView;->da:Landroid/widget/PageView$OnPageChangeListener;
...
.method private b(F)Z
    ...
    invoke-direct {p0, v1}, Landroid/widget/PageView;->e(I)Z
...
.method private e(I)Z
    ...
    invoke-virtual {p0, v2, p1, v2}, Landroid/widget/PageView;->a(IFI)V
    ...
    :cond_1
    invoke-direct {p0}, Landroid/widget/PageView;->h()Landroid/widget/PageView$ItemInfo;
    ...
    iget v6, v0, Landroid/widget/PageView$ItemInfo;->b:I

    int-to-float p1, p1

    div-float/2addr p1, v3

    iget v3, v0, Landroid/widget/PageView$ItemInfo;->e:F
    ...
    invoke-virtual {p0, v6, p1, v0}, Landroid/widget/PageView;->a(IFI)V
...
.method private h()Landroid/widget/PageView$ItemInfo;
    .locals 12
...
.method private k()V
    ...
    iget v0, p0, Landroid/widget/PageView;->ha:I

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/widget/PageView;->ia:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/widget/PageView;->ia:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Landroid/widget/PageView;->ia:Ljava/util/ArrayList;
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/widget/PageView;->fa:Landroid/widget/PageView$PageTransformer;
...
.method a(I)Landroid/widget/PageView$ItemInfo;
    .locals 3
...
.method a(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method protected a(IFI)V
    ...
    iget-object p1, p0, Landroid/widget/PageView;->fa:Landroid/widget/PageView$PageTransformer;
    ...
    iget-object v3, p0, Landroid/widget/PageView;->fa:Landroid/widget/PageView$PageTransformer;
...
.method a(III)V
    ...
    invoke-virtual {p0}, Landroid/widget/PageView;->f()V
...
.method a(IZZI)V
    ...
    :cond_8
    invoke-virtual {p0, p1}, Landroid/widget/PageView;->b(I)V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method public addOnPageChangeListener(Landroid/widget/PageView$OnPageChangeListener;)V
    ...
    iput-object v0, p0, Landroid/widget/PageView;->ba:Ljava/util/List;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method b(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/widget/PageView;->a(I)Landroid/widget/PageView$ItemInfo;
    ...
    invoke-direct/range {p0 .. p0}, Landroid/widget/PageView;->k()V
    ...
    :cond_12
    iget v12, v6, Landroid/widget/PageView$ItemInfo;->b:I

    if-ne v8, v12, :cond_16

    iget-boolean v12, v6, Landroid/widget/PageView$ItemInfo;->c:Z
    ...
    iget-object v12, v0, Landroid/widget/PageView;->i:Landroid/widget/BasePageAdapter;

    iget-object v6, v6, Landroid/widget/PageView$ItemInfo;->a:Ljava/lang/Object;

    invoke-virtual {v12, v0, v8, v6}, Landroid/widget/BasePageAdapter;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    :cond_17
    :goto_f
    invoke-direct {v0, v9, v11, v4}, Landroid/widget/PageView;->a(Landroid/widget/PageView$ItemInfo;ILandroid/widget/PageView$ItemInfo;)V
    ...
    invoke-virtual {v0, v4}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
    ...
    invoke-virtual {v0, v1}, Landroid/widget/PageView;->a(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
    ...
    invoke-virtual {v0, v3}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method public computeScroll()V
    ...
    invoke-direct {p0, v2}, Landroid/widget/PageView;->e(I)Z
...
.method e()Z
    ...
    iget v1, p0, Landroid/widget/PageView;->j:I
...
.method f()V
    ...
    invoke-virtual {p0, v0}, Landroid/widget/PageView;->b(I)V
...
.method protected getChildDrawingOrder(II)I
    ...
    :cond_0
    iget-object p1, p0, Landroid/widget/PageView;->ia:Ljava/util/ArrayList;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroid/widget/PageView;->ka:Ljava/lang/Runnable;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v13, v0, Landroid/widget/PageView;->q:Landroid/graphics/drawable/Drawable;

    float-to-int v14, v12

    iget v15, v0, Landroid/widget/PageView;->r:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, v6, Landroid/widget/PageView;->la:Z
    ...
    iget v0, v6, Landroid/widget/PageView;->ja:I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/widget/PageView;->f()V
    ...
    :cond_f
    :goto_3
    invoke-direct/range {p0 .. p0}, Landroid/widget/PageView;->j()Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v6}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method protected onMeasure(II)V
    ...
    iget v1, p0, Landroid/widget/PageView;->D:I

    invoke-static {p2, v1}, Ljava/lang/Math;->min(II)I

    move-result p2

    iput p2, p0, Landroid/widget/PageView;->E:I
    ...
    check-cast v3, Landroid/widget/PageView$LayoutParams;

    if-eqz v3, :cond_b

    iget-boolean v7, v3, Landroid/widget/PageView$LayoutParams;->isDecor:Z

    if-eqz v7, :cond_b

    iget v7, v3, Landroid/widget/PageView$LayoutParams;->gravity:I
    ...
    iput p1, p0, Landroid/widget/PageView;->v:I

    invoke-static {v2, v5}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result p1

    iput p1, p0, Landroid/widget/PageView;->w:I

    iput-boolean v4, p0, Landroid/widget/PageView;->x:Z

    invoke-virtual {p0}, Landroid/widget/PageView;->f()V

    iput-boolean v0, p0, Landroid/widget/PageView;->x:Z
    ...
    iget-boolean v4, v2, Landroid/widget/PageView$LayoutParams;->isDecor:Z
    ...
    iget v2, v2, Landroid/widget/PageView$LayoutParams;->a:F
    ...
    iget v4, p0, Landroid/widget/PageView;->w:I
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/widget/PageView;->b(Landroid/view/View;)Landroid/widget/PageView$ItemInfo;
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-direct {p0, p1, p3, p2, p2}, Landroid/widget/PageView;->a(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v3, p0, Landroid/widget/PageView;->F:I
    ...
    :goto_0
    iput v4, p0, Landroid/widget/PageView;->G:F
    ...
    :goto_1
    invoke-direct {p0}, Landroid/widget/PageView;->j()Z
...
.method public setAdapter(Landroid/widget/BasePageAdapter;)V
    ...
    invoke-direct {p0}, Landroid/widget/PageView;->i()V
    ...
    :cond_5
    :goto_1
    iget-object v1, p0, Landroid/widget/PageView;->ea:Landroid/widget/PageView$OnAdapterChangeListener;
...
.method setChildrenDrawingOrderEnabledCompat(Z)V
    ...
    iget-object v0, p0, Landroid/widget/PageView;->ga:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Landroid/widget/PageView;->ga:Ljava/lang/reflect/Method;
    :try_end_1
...
.method setOnAdapterChangeListener(Landroid/widget/PageView$OnAdapterChangeListener;)V
    ...
    iput-object p1, p0, Landroid/widget/PageView;->ea:Landroid/widget/PageView$OnAdapterChangeListener;
...
.method public setOnPageChangeListener(Landroid/widget/PageView$OnPageChangeListener;)V
    ...
    iput-object p1, p0, Landroid/widget/PageView;->ca:Landroid/widget/PageView$OnPageChangeListener;
...
.method public setPageTransformer(ZLandroid/widget/PageView$PageTransformer;)V
    ...
    :goto_2
    iput-object p2, p0, Landroid/widget/PageView;->fa:Landroid/widget/PageView$PageTransformer;
    ...
    :cond_3
    iput v0, p0, Landroid/widget/PageView;->ha:I

    goto :goto_3

    :cond_4
    iput v1, p0, Landroid/widget/PageView;->ha:I
...
.method public setScrollEnabled(Z)V
    ...
    iput-boolean p1, p0, Landroid/widget/PageView;->la:Z
