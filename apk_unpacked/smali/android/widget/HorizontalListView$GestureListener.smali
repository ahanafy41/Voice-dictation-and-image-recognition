...
.method public onLongPress(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v0}, Landroid/widget/HorizontalListView;->e(Landroid/widget/HorizontalListView;)V
    ...
    invoke-static {v0}, Landroid/widget/HorizontalListView;->b(Landroid/widget/HorizontalListView;)Z
    ...
    invoke-static {v0}, Landroid/widget/HorizontalListView;->c(Landroid/widget/HorizontalListView;)I
    ...
    iget-object p1, v2, Landroid/widget/HorizontalListView;->f:Landroid/widget/ListAdapter;
...
.method public onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    invoke-static {p1}, Landroid/widget/HorizontalListView;->e(Landroid/widget/HorizontalListView;)V

    iget-object p1, p0, Landroid/widget/HorizontalListView$GestureListener;->a:Landroid/widget/HorizontalListView;

    iget p4, p1, Landroid/widget/HorizontalListView;->n:I

    float-to-int v0, p3

    add-int/2addr p4, v0

    iput p4, p1, Landroid/widget/HorizontalListView;->n:I
...
.method public onSingleTapConfirmed(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1}, Landroid/widget/HorizontalListView;->d(Landroid/widget/HorizontalListView;)Landroid/view/View$OnClickListener;
    ...
    invoke-static {p1}, Landroid/widget/HorizontalListView;->b(Landroid/widget/HorizontalListView;)Z
