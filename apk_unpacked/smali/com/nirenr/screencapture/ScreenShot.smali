...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/VirtualDisplay$Callback;)V
    ...
    iget-object p2, p0, Lcom/nirenr/screencapture/ScreenShot;->e:Landroid/content/Context;
...
.method static synthetic b(Lcom/nirenr/screencapture/ScreenShot;)Lcom/nirenr/screencapture/ScreenCaptureListener;
    ...
    iget-object p0, p0, Lcom/nirenr/screencapture/ScreenShot;->g:Lcom/nirenr/screencapture/ScreenCaptureListener;
...
.method public static getScreenCaptureBitmap(Lcom/androlua/LuaAccessibilityService;Lcom/nirenr/screencapture/ScreenCaptureListener;)V
    ...
    invoke-virtual {p0, v2}, Landroid/accessibilityservice/AccessibilityService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v7, v8, v2, v2}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;
    ...
    invoke-virtual {p0, v3}, Landroid/accessibilityservice/AccessibilityService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v4, Lcom/nirenr/screencapture/ScreenShot;->c:Landroid/content/Intent;

    invoke-virtual {p0, v3, v4}, Landroid/media/projection/MediaProjectionManager;->getMediaProjection(ILandroid/content/Intent;)Landroid/media/projection/MediaProjection;
    ...
    invoke-interface {p1, v0}, Lcom/nirenr/screencapture/ScreenCaptureListener;->onScreenCaptureError(Ljava/lang/String;)V
    ...
    invoke-static {v8, v5, v5, v4, v7}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;

    move-result-object v4

    invoke-virtual {v6}, Landroid/media/Image;->close()V

    invoke-interface {p1, v4}, Lcom/nirenr/screencapture/ScreenCaptureListener;->onScreenCaptureDone(Landroid/graphics/Bitmap;)V
...
.method private k()V
    ...
    iget-object v8, p0, Lcom/nirenr/screencapture/ScreenShot;->f:Landroid/hardware/display/VirtualDisplay$Callback;
