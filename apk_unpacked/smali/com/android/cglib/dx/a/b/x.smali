.class public final Lcom/android/cglib/dx/a/b/x;
...
.method public a()Lcom/android/cglib/dx/a/b/C;
    ...
    sget-object v0, Lcom/android/cglib/dx/a/b/C;->a:Lcom/android/cglib/dx/a/b/C;
...
.method public a(Lcom/android/cglib/dx/a/b/p;Lcom/android/cglib/dx/d/a;)V
    ...
    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->i()Lcom/android/cglib/dx/a/b/L;
    ...
    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->g()Lcom/android/cglib/dx/a/b/Q;

    move-result-object v1

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->h()Lcom/android/cglib/dx/a/b/Q;

    move-result-object v2

    invoke-virtual {v1}, Lcom/android/cglib/dx/a/b/Q;->c()I

    move-result v1

    invoke-virtual {v2}, Lcom/android/cglib/dx/a/b/Q;->c()I

    move-result v3

    invoke-virtual {v2}, Lcom/android/cglib/dx/a/b/Q;->i()I
    ...
    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->d()Lcom/android/cglib/dx/a/b;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/cglib/dx/a/b;->b()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/android/cglib/dx/c/c/v;->i()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->f()I
    ...
    invoke-interface {p2, v9}, Lcom/android/cglib/dx/d/q;->writeByte(I)V
    ...
    invoke-interface {p2, v2}, Lcom/android/cglib/dx/d/q;->a(I)V
    ...
    invoke-interface {p2, v6}, Lcom/android/cglib/dx/d/q;->writeInt(I)V

    invoke-interface {p2, v5}, Lcom/android/cglib/dx/d/q;->writeInt(I)V

    invoke-interface {p2, v7}, Lcom/android/cglib/dx/d/q;->a(I)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/cglib/dx/a/b/V;->d(Lcom/android/cglib/dx/d/a;)V

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->o()Lcom/android/cglib/dx/a/b/X;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/android/cglib/dx/a/b/X;->d(Lcom/android/cglib/dx/d/a;)V

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->k()Lcom/android/cglib/dx/a/b/P;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/android/cglib/dx/a/b/P;->d(Lcom/android/cglib/dx/d/a;)V

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->e()Lcom/android/cglib/dx/a/b/w;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/android/cglib/dx/a/b/w;->d(Lcom/android/cglib/dx/d/a;)V

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->j()Lcom/android/cglib/dx/a/b/I;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/android/cglib/dx/a/b/I;->d(Lcom/android/cglib/dx/d/a;)V

    invoke-virtual {p1}, Lcom/android/cglib/dx/a/b/p;->c()Lcom/android/cglib/dx/a/b/i;

    move-result-object p1

    invoke-virtual {p1, p2}, Lcom/android/cglib/dx/a/b/i;->d(Lcom/android/cglib/dx/d/a;)V
