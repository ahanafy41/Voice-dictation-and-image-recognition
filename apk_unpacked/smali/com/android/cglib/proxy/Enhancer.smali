...
.method private a(Lcom/android/cglib/dx/DexMaker;Lcom/android/cglib/dx/TypeId;Lcom/android/cglib/dx/TypeId;)V
    ...
    const-class v0, Lcom/android/cglib/proxy/MethodInterceptor;

    invoke-static {v0}, Lcom/android/cglib/dx/TypeId;->get(Ljava/lang/Class;)Lcom/android/cglib/dx/TypeId;

    move-result-object v7

    const-class v0, Lcom/android/cglib/proxy/MethodProxyExecuter;
    ...
    const-string v0, "methodInterceptor"

    invoke-virtual {v10, v7, v0}, Lcom/android/cglib/dx/TypeId;->getField(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;)Lcom/android/cglib/dx/FieldId;
    ...
    invoke-virtual {v9, v5, v4, v0}, Lcom/android/cglib/dx/DexMaker;->declare(Lcom/android/cglib/dx/FieldId;ILjava/lang/Object;)V

    iget-object v0, v8, Lcom/android/cglib/proxy/Enhancer;->b:Ljava/lang/Class;
    ...
    sget-object v0, Lcom/android/cglib/dx/TypeId;->VOID:Lcom/android/cglib/dx/TypeId;

    const/4 v1, 0x1

    new-array v2, v1, [Lcom/android/cglib/dx/TypeId;

    aput-object v7, v2, v11

    const-string v3, "setMethodInterceptor_Enhancer"

    invoke-virtual {v10, v0, v3, v2}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;

    move-result-object v0

    invoke-virtual {v9, v0, v1}, Lcom/android/cglib/dx/DexMaker;->declare(Lcom/android/cglib/dx/MethodId;I)Lcom/android/cglib/dx/Code;

    move-result-object v0

    invoke-virtual {v0, v10}, Lcom/android/cglib/dx/Code;->getThis(Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;

    move-result-object v2

    invoke-virtual {v0, v11, v7}, Lcom/android/cglib/dx/Code;->getParameter(ILcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;

    move-result-object v3

    move-object/from16 v8, v19

    invoke-virtual {v0, v8, v2, v3}, Lcom/android/cglib/dx/Code;->iput(Lcom/android/cglib/dx/FieldId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;)V
    ...
    new-array v3, v2, [Lcom/android/cglib/dx/TypeId;
    ...
    const-string v6, "executeSuperMethod_Enhancer"

    invoke-virtual {v10, v0, v6, v3}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;
    ...
    invoke-virtual {v0, v15}, Lcom/android/cglib/dx/Code;->newLocal(Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;

    move-result-object v3

    invoke-virtual {v0, v12}, Lcom/android/cglib/dx/Code;->newLocal(Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;
    ...
    new-array v2, v11, [Lcom/android/cglib/dx/TypeId;

    const-string v5, "getClass"

    invoke-virtual {v10, v12, v5, v2}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;

    move-result-object v2

    new-array v5, v11, [Lcom/android/cglib/dx/Local;

    invoke-virtual {v0, v2, v6, v7, v5}, Lcom/android/cglib/dx/Code;->invokeVirtual(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V

    sget-object v2, Lcom/android/cglib/dx/TypeId;->OBJECT:Lcom/android/cglib/dx/TypeId;

    const/4 v5, 0x5

    new-array v9, v5, [Lcom/android/cglib/dx/TypeId;
    ...
    const-string v15, "executeMethod"

    move-object/from16 v12, v16

    invoke-virtual {v12, v2, v15, v9}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;

    move-result-object v2

    new-array v5, v5, [Lcom/android/cglib/dx/Local;

    aput-object v6, v5, v11

    invoke-virtual {v0, v11, v14}, Lcom/android/cglib/dx/Code;->getParameter(ILcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;

    move-result-object v6

    aput-object v6, v5, v1

    invoke-virtual {v0, v1, v13}, Lcom/android/cglib/dx/Code;->getParameter(ILcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;
    ...
    invoke-virtual {v0, v6, v4}, Lcom/android/cglib/dx/Code;->getParameter(ILcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;
    ...
    invoke-virtual {v0, v2, v3, v5}, Lcom/android/cglib/dx/Code;->invokeStatic(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V

    invoke-virtual {v0, v3}, Lcom/android/cglib/dx/Code;->returnValue(Lcom/android/cglib/dx/Local;)V

    move-object/from16 v9, p0

    iget-object v0, v9, Lcom/android/cglib/proxy/Enhancer;->b:Ljava/lang/Class;
    ...
    iget-object v0, v9, Lcom/android/cglib/proxy/Enhancer;->d:Lcom/android/cglib/proxy/MethodFilter;

    if-eqz v0, :cond_6

    invoke-interface {v0, v5, v6}, Lcom/android/cglib/proxy/MethodFilter;->filter(Ljava/lang/reflect/Method;Ljava/lang/String;)Z
...
.method private a(Lcom/android/cglib/dx/DexMaker;Lcom/android/cglib/dx/TypeId;Lcom/android/cglib/dx/TypeId;Ljava/lang/reflect/Method;Ljava/lang/String;Lcom/android/cglib/dx/FieldId;)V
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/cglib/dx/TypeId;->get(Ljava/lang/Class;)Lcom/android/cglib/dx/TypeId;
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/cglib/dx/TypeId;->get(Ljava/lang/Class;)Lcom/android/cglib/dx/TypeId;
    ...
    new-array v3, v10, [Lcom/android/cglib/dx/TypeId;

    move-object/from16 v31, v0

    const-string v0, "getClass"

    invoke-virtual {v2, v6, v0, v3}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;

    move-result-object v0

    new-array v3, v10, [Lcom/android/cglib/dx/Local;

    invoke-virtual {v5, v0, v8, v9, v3}, Lcom/android/cglib/dx/Code;->invokeVirtual(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V
    ...
    invoke-virtual {v3, v3, v14, v11}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;

    move-result-object v3

    new-array v11, v10, [Lcom/android/cglib/dx/Local;

    aget-object v10, v1, v0

    invoke-virtual {v5, v0, v10}, Lcom/android/cglib/dx/Code;->getParameter(ILcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/Local;
    ...
    invoke-virtual {v5, v3, v10, v11}, Lcom/android/cglib/dx/Code;->invokeStatic(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V

    invoke-virtual {v5, v7, v12, v10}, Lcom/android/cglib/dx/Code;->aput(Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;)V
    ...
    new-array v10, v3, [Lcom/android/cglib/dx/TypeId;
    ...
    const-string v14, "executeInterceptor"

    move-object/from16 v12, v19

    invoke-virtual {v12, v0, v14, v10}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;
    ...
    :goto_7
    new-array v3, v3, [Lcom/android/cglib/dx/Local;
    ...
    invoke-virtual {v5, v0, v10, v3}, Lcom/android/cglib/dx/Code;->invokeStatic(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V
    ...
    invoke-virtual {v5, v3, v4}, Lcom/android/cglib/dx/Code;->loadConstant(Lcom/android/cglib/dx/Local;Ljava/lang/Object;)V

    sget-object v6, Lcom/android/cglib/dx/Comparison;->EQ:Lcom/android/cglib/dx/Comparison;

    move-object/from16 v7, v29

    invoke-virtual {v5, v6, v0, v7, v3}, Lcom/android/cglib/dx/Code;->compare(Lcom/android/cglib/dx/Comparison;Lcom/android/cglib/dx/Label;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;)V

    invoke-virtual {v5, v3, v7}, Lcom/android/cglib/dx/Code;->cast(Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;)V

    invoke-static/range {v22 .. v22}, Lcom/android/cglib/proxy/Const;->getPackedType(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/cglib/proxy/Const;->getPrimitiveValueMethodName(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v10, v7, v9}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;
    ...
    invoke-virtual {v5, v6, v9, v3, v7}, Lcom/android/cglib/dx/Code;->invokeVirtual(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V

    invoke-virtual {v5, v9}, Lcom/android/cglib/dx/Code;->returnValue(Lcom/android/cglib/dx/Local;)V

    invoke-virtual {v5, v0}, Lcom/android/cglib/dx/Code;->mark(Lcom/android/cglib/dx/Label;)V
    ...
    invoke-virtual {v5, v9, v7}, Lcom/android/cglib/dx/Code;->cast(Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;)V
    ...
    invoke-virtual {v3, v10, v5, v1}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;
    ...
    invoke-virtual {v3, v10, v5, v7}, Lcom/android/cglib/dx/TypeId;->getMethod(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;[Lcom/android/cglib/dx/TypeId;)Lcom/android/cglib/dx/MethodId;
    ...
    invoke-virtual {v6, v0, v5}, Lcom/android/cglib/dx/DexMaker;->declare(Lcom/android/cglib/dx/MethodId;I)Lcom/android/cglib/dx/Code;
    ...
    :goto_c
    invoke-virtual {v0, v3, v4, v2, v7}, Lcom/android/cglib/dx/Code;->invokeSuper(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V
    ...
    invoke-virtual {v0, v3, v4, v2, v1}, Lcom/android/cglib/dx/Code;->invokeSuper(Lcom/android/cglib/dx/MethodId;Lcom/android/cglib/dx/Local;Lcom/android/cglib/dx/Local;[Lcom/android/cglib/dx/Local;)V
    ...
    :cond_f
    invoke-virtual {v0, v5}, Lcom/android/cglib/dx/Code;->returnValue(Lcom/android/cglib/dx/Local;)V
...
.method public create()Ljava/lang/Class;
    ...
    const-class v4, Lcom/android/cglib/proxy/EnhancerInterface;

    invoke-static {v4}, Lcom/android/cglib/dx/TypeId;->get(Ljava/lang/Class;)Lcom/android/cglib/dx/TypeId;

    move-result-object v4

    iget-object v5, p0, Lcom/android/cglib/proxy/Enhancer;->a:Landroid/content/Context;
    ...
    new-instance v12, Lcom/android/cglib/dx/DexMaker;

    invoke-direct {v12}, Lcom/android/cglib/dx/DexMaker;-><init>()V
    ...
    new-array v10, v0, [Lcom/android/cglib/dx/TypeId;
    ...
    invoke-virtual/range {v5 .. v10}, Lcom/android/cglib/dx/DexMaker;->declare(Lcom/android/cglib/dx/TypeId;Ljava/lang/String;ILcom/android/cglib/dx/TypeId;[Lcom/android/cglib/dx/TypeId;)V

    invoke-direct {p0, v12, v2, v3}, Lcom/android/cglib/proxy/Enhancer;->a(Lcom/android/cglib/dx/DexMaker;Lcom/android/cglib/dx/TypeId;Lcom/android/cglib/dx/TypeId;)V
    ...
    invoke-virtual {v12, v0, v2}, Lcom/android/cglib/dx/DexMaker;->generateAndLoad(Ljava/lang/ClassLoader;Ljava/io/File;)Ljava/lang/ClassLoader;
    ...
    invoke-static {v1}, Lcom/androlua/LuaUtil;->rmDir(Ljava/io/File;)Z
