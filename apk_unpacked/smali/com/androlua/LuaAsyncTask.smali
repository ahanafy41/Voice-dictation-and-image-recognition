...
.method public constructor <init>(Lcom/androlua/LuaContext;Lcom/luajava/LuaObject;Lcom/luajava/LuaObject;)V
    ...
    iput-object p1, p0, Lcom/androlua/LuaAsyncTask;->p:[B
    ...
    iput-object p1, p0, Lcom/androlua/LuaAsyncTask;->l:[Ljava/lang/Object;
...
.method protected a([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-wide v1, p0, Lcom/androlua/LuaAsyncTask;->q:J
    ...
    iput-object v1, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;
    ...
    iget-object v2, p0, Lcom/androlua/LuaAsyncTask;->o:Lcom/androlua/LuaContext;

    invoke-virtual {v1, v2}, Lcom/luajava/LuaState;->pushJavaObject(Ljava/lang/Object;)V

    iget-object v1, p0, Lcom/androlua/LuaAsyncTask;->o:Lcom/androlua/LuaContext;

    instance-of v2, v1, Lcom/androlua/LuaActivity;
    ...
    :goto_0
    invoke-virtual {v1, v2}, Lcom/luajava/LuaState;->setGlobal(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    instance-of v1, v1, Lcom/androlua/LuaService;
    ...
    invoke-virtual {v1, p0}, Lcom/luajava/LuaState;->pushJavaObject(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v2}, Lcom/luajava/LuaState;->pushContext(Lcom/androlua/LuaContext;)V
    ...
    const-string v3, "luadir"

    invoke-virtual {v1, v2, v3}, Lcom/luajava/LuaState;->setField(ILjava/lang/String;)V
    ...
    :try_start_1
    new-instance v1, Lcom/androlua/LuaPrint;

    iget-object v4, p0, Lcom/androlua/LuaAsyncTask;->o:Lcom/androlua/LuaContext;

    iget-object v5, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    invoke-direct {v1, v4, v5}, Lcom/androlua/LuaPrint;-><init>(Lcom/androlua/LuaContext;Lcom/luajava/LuaState;)V

    const-string v4, "print"

    invoke-virtual {v1, v4}, Lcom/luajava/JavaFunction;->register(Ljava/lang/String;)V

    new-instance v1, Lcom/androlua/LuaAsyncTask$1;

    iget-object v4, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    invoke-direct {v1, p0, v4}, Lcom/androlua/LuaAsyncTask$1;-><init>(Lcom/androlua/LuaAsyncTask;Lcom/luajava/LuaState;)V
    ...
    invoke-virtual {v1, v4}, Lcom/luajava/LuaState;->getGlobal(Ljava/lang/String;)I

    iget-object v1, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    iget-object v4, p0, Lcom/androlua/LuaAsyncTask;->o:Lcom/androlua/LuaContext;

    invoke-interface {v4}, Lcom/androlua/LuaContext;->getLuaLpath()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, v4}, Lcom/luajava/LuaState;->pushString(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    const-string v4, "path"

    invoke-virtual {v1, v2, v4}, Lcom/luajava/LuaState;->setField(ILjava/lang/String;)V

    iget-object v1, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    iget-object v4, p0, Lcom/androlua/LuaAsyncTask;->o:Lcom/androlua/LuaContext;

    invoke-interface {v4}, Lcom/androlua/LuaContext;->getLuaCpath()Ljava/lang/String;
    ...
    invoke-interface {v4, v5, v1}, Lcom/androlua/LuaContext;->sendError(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_2
    iget-object v1, p0, Lcom/androlua/LuaAsyncTask;->l:[Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5}, Lcom/luajava/LuaState;->getLuaObject(Ljava/lang/String;)Lcom/luajava/LuaObject;
    ...
    invoke-virtual {v1, v0}, Lcom/luajava/LuaState;->getLuaObject(Ljava/lang/String;)Lcom/luajava/LuaObject;
    ...
    invoke-virtual {v0, v4}, Lcom/luajava/LuaState;->setTop(I)V
    ...
    invoke-virtual {v0, v1, v5}, Lcom/luajava/LuaState;->LloadBuffer([BLjava/lang/String;)I
    ...
    invoke-virtual {v0, v1, v5}, Lcom/luajava/LuaState;->getField(ILjava/lang/String;)I
    ...
    iget-object v6, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;
    ...
    :cond_4
    iget-object p1, p0, Lcom/androlua/LuaAsyncTask;->n:Lcom/luajava/LuaState;

    sub-int/2addr v2, v0

    invoke-virtual {p1, v0, v1, v2}, Lcom/luajava/LuaState;->pcall(III)I
