...
.method public run()V
    ...
    iget-object v3, v2, Lcom/androlua/util/TimerTaskX;->a:Ljava/lang/Object;
    ...
    :try_start_3
    iget-boolean v4, v2, Lcom/androlua/util/TimerTaskX;->b:Z
    ...
    :cond_4
    iget-wide v6, v2, Lcom/androlua/util/TimerTaskX;->c:J
    ...
    iget-wide v6, v4, Lcom/androlua/util/TimerTaskX;->c:J

    iget-wide v8, v2, Lcom/androlua/util/TimerTaskX;->c:J
    ...
    iget-wide v4, v2, Lcom/androlua/util/TimerTaskX;->d:J

    cmp-long v6, v4, v0

    if-ltz v6, :cond_9

    iget-boolean v0, v2, Lcom/androlua/util/TimerTaskX;->e:Z

    if-eqz v0, :cond_8

    iget-wide v0, v2, Lcom/androlua/util/TimerTaskX;->c:J
    ...
    iput-wide v0, v2, Lcom/androlua/util/TimerTaskX;->c:J
