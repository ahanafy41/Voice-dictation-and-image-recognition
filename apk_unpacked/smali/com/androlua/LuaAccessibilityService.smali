...
.method public findAccessibilityNodeInfoByText(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v0, v10}, Lcom/androlua/LuaAccessibilityService;->findAccessibilityNodeInfo(Ljava/lang/String;)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/androlua/LuaAccessibilityService;->getFocusView()Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {v0, v3, v2, v1}, Lcom/androlua/LuaAccessibilityService;->a(Ljava/util/List;Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/String;)V
...
.method public insert(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/accessibilityservice/AccessibilityService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public installApp(Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Landroid/accessibilityservice/AccessibilityService;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    sget-object v1, Lcom/androlua/LuaAccessibilityService;->a:Lcom/androlua/LuaAccessibilityService$AccessibilityServiceCallbacks;

    if-eqz v1, :cond_0

    invoke-interface {v1, p0, p1}, Lcom/androlua/LuaAccessibilityService$AccessibilityServiceCallbacks;->onAccessibilityEvent(Lcom/androlua/LuaAccessibilityService;Landroid/view/accessibility/AccessibilityEvent;)V

    :cond_0
    sget-object v1, Lcom/androlua/LuaAccessibilityService;->onAccessibilityEvent:Lcom/luajava/LuaFunction;
    ...
    invoke-virtual {v1, v0}, Lcom/luajava/LuaFunction;->call([Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    :cond_1
    iget-object v1, p0, Lcom/androlua/LuaAccessibilityService;->d:Ljava/util/Map;

    const-string v4, "LuaAccessibilityService"
    ...
    :cond_3
    :try_start_1
    invoke-virtual {v1, v0}, Lcom/luajava/LuaTable;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/luajava/LuaFunction;

    new-array v5, v3, [Ljava/lang/Object;

    aput-object p1, v5, v2

    invoke-virtual {v4, v5}, Lcom/luajava/LuaFunction;->call([Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {v1, v4}, Lcom/luajava/LuaTable;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onCreate()V
    ...
    iput-object v1, p0, Lcom/androlua/LuaAccessibilityService;->g:Landroid/os/Handler;
    ...
    new-instance v1, Lcom/androlua/util/GlobalActionAutomator;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    invoke-direct {v1, p0, v2}, Lcom/androlua/util/GlobalActionAutomator;-><init>(Landroid/accessibilityservice/AccessibilityService;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/androlua/LuaAccessibilityService;->h:Lcom/androlua/util/GlobalActionAutomator;

    iget-object v1, p0, Lcom/androlua/LuaAccessibilityService;->h:Lcom/androlua/util/GlobalActionAutomator;

    invoke-virtual {v1, p0}, Lcom/androlua/util/GlobalActionAutomator;->setService(Landroid/accessibilityservice/AccessibilityService;)V
    ...
    invoke-interface {v1, p0}, Lcom/androlua/LuaAccessibilityService$AccessibilityServiceCallbacks;->onCreate(Lcom/androlua/LuaAccessibilityService;)V
    ...
    iput-object v1, p0, Lcom/androlua/LuaAccessibilityService;->c:Lcom/androlua/LuaApplication;

    iget-object v1, p0, Lcom/androlua/LuaAccessibilityService;->c:Lcom/androlua/LuaApplication;

    invoke-virtual {v1}, Lcom/androlua/LuaApplication;->getGlobalData()Ljava/util/Map;

    move-result-object v1

    iput-object v1, p0, Lcom/androlua/LuaAccessibilityService;->d:Ljava/util/Map;

    iget-object v1, p0, Lcom/androlua/LuaAccessibilityService;->d:Ljava/util/Map;

    const-string v2, "LuaAccessibilityService"
    ...
    invoke-virtual {v1, v5}, Lcom/luajava/LuaTable;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected onServiceConnected()V
    ...
    invoke-interface {v1, p0}, Lcom/androlua/LuaAccessibilityService$AccessibilityServiceCallbacks;->onServiceConnected(Lcom/androlua/LuaAccessibilityService;)V
...
.method public swipe(Landroid/graphics/Path;I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/androlua/util/GlobalActionAutomator;->gesture(JJLandroid/graphics/Path;)Z
